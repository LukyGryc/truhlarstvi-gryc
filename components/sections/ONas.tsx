const ONas = () => {
  return (
    <section id="onas" className="bg-[url(/woodworker.jpg)] bg-cover min-h-screen ">
      <div className="h-auto p-10 md:p-20 bg-black/70 relative top-20 md:top-40 sm:w-full md:w-3/4 lg:w-1/2">
